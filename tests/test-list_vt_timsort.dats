...
test_array_of_size
  ...
  let
    ...
    val lst1 = array2list (!p_arr, n)
    val t11 = get_clock ()
    val expected = list_vt_mergesort<entry_t> lst1
    val t12 = get_clock ()
    val t1 = t12 - t11
    ...
    val lst1 = array2list (!p_arr, n)
    val t21 = get_clock ()
    val gotten = list_vt_timsort<entry_t> lst1
    val t22 = get_clock ()
    val t2 = t22 - t21
  ...
  in
    print! "  list_vt_mergesort:";
    print! t1;
    print! "  list_vt_timsort:";
    print! t2;
    print! "  ";
    print! n;
    println! ()
